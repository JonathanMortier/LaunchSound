 ...
 */
class SouthParkActivity : SoundButtonActivity() {

    private var southParkSoundList: List<ButtonInfos>? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        for (buttonInfos in southParkSoundList!!) {
    ...
    override fun onPause() {
        ...
        editor.clear()
        MainActivity.getSouthParkSoundList()?.forEach { button ->
